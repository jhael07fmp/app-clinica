...
import { UpdatePersonAddressForm } from "../../models/input.model";
...
function UpdatePersonAddress(): React.JSX.Element {
  const {
    handleSubmit,
    register,
    reset,
    formState: { errors },
  } = useForm<UpdatePersonAddressForm>();

  const { postData } = useHttpMethod<UpdatePersonAddressForm>({
    url: enviroments.updatePersonAddress,
  });
  ...
  return (
    <>
      ...
      <Form title="Actualizar dirección de la Persona" onSubmit={onSubmit}>
        <div className="mb-3">
          ...
          />
          {errors.addressId && <InputErrorMessage message={errors.addressId.message} />}
        </div>
        <div className="mb-3">
          ...
          />
          {errors.personNif && <InputErrorMessage message={errors.personNif.message} />}
        </div>
        <div className="mb-3">
          ...
          />
          {errors.personName && <InputErrorMessage message={errors.personName.message} />}
        </div>
        <div className="mb-3">
          ...
          />
          {errors.streetNumber && <InputErrorMessage message={errors.streetNumber.message} />}
        </div>
        <div className="mb-3">
          ...
          />
          {errors.addressLine1 && <InputErrorMessage message={errors.addressLine1.message} />}
        </div>
        <div className="mb-3">
        ...
        <div className="mb-3">
          ...
          />
          {errors.population && <InputErrorMessage message={errors.population.message} />}
        </div>
        <div className="mb-3">
          ...
          />
          {errors.postalCode && <InputErrorMessage message={errors.postalCode.message} />}
        </div>
        <div className="mb-3">
          ...
          />
          {errors.province && <InputErrorMessage message={errors.province.message} />}
        </div>
      </Form>
    </>
  );
