        ...
        <div className="container d-flex flex-column justify-content-center align-items-center">
          ...
          <div className="col-lg-10">
            ...
            <table className="table table-striped table-hover table-bordered mt-4">
              <TableHeader columns={columns} setSorting={setSorting} sorting={sorting} />
              <TableContent columns={columns} items={items?.data.items ?? []} />
            </table>
            <button type="button" className="btn btn-outline-dark me-3" onClick={handleNextPage}>
              Siguiente Página
            </button>
            <button
              type="button"
            ...
            <button type="button" className="btn btn-outline-dark" onClick={handleRefresh}>
              Recargar
            </button>
          </div>
        </div>
